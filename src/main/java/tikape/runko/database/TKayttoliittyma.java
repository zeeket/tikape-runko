...
public class TKayttoliittyma {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //näin lisäysmetodeja käytetään:
        //System.out.println("Lisataan alue, lanka ja viesti");
        // int alueId= (aluedao.lisaa("Ruoka", "Nam nam maisuvia ruokia")).getId();
        // int lankaId = (lankadao.lisaa("Creme brulee", alueId).getId());
        // viestidao.lisaa("Creme brulee ei saa olla liian palanut pinnalta", "Nelli", lankaId);
