...
//        lista.add("DROP TABLE Viesti;");
        ...
        lista.add("CREATE TABLE viesti (id integer PRIMARY KEY, sisalto text NOT NULL, aika timestamptz NOT NULL, nimimerkki varchar(15) NOT NULL, lanka integer NOT NULL, FOREIGN KEY(lanka) REFERENCES lanka(id));");
